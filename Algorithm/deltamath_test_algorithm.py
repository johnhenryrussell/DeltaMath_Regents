...
def assign_numbers_to_values(question_data, col_name="Cluster"):
    ...
    """
    unique_values = question_data[col_name].unique().tolist()
...
question_data[["easy_weight", "normal_weight", "hard_weight"]] = question_data.apply(
...
choose_questions(question_data, easy_weight_list, 100)
